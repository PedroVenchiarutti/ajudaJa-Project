...
export const FAQ5ToUp = (FAQ4, FAQ5) => { 
    if(FAQ4) { 
        return 'animate-contentClass w-[300px] sm:w-[500px] md:w-[750px] lg:w-[880px] xl:w-[950px]  title p-4 flex justify-between bg-faqGreenBg rounded-md relative mb-[-5px] z-50 mt-[160px] md:mt-[80px] sm:mt-[100px]'
    } else if(!FAQ4 && FAQ5){ 
