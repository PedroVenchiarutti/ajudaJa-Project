      ...
      <div className="max-w-[1200px] pr-5 pt-24 md:pt-32 m-auto pb-16 ">
        <div className="content grid md:grid-cols-2 items-center text-[#0f0f0f]">
          <div className="textAndImage    text-6xl leading-[65px] md:leading-[70px] px-10 md:px-0  md:text-right md:pr-16 ">
            <h1>
              Saia de casa <br />{' '}
              <span className="font-medium text-firstSessionFontColor">
                {' '}
                sem se
              </span>{' '}
              <br />{' '}
              <span className="font-bold">
                <span className="text-firstSessionFontColor">preocupar</span>{' '}
                com
              </span>{' '}
              <br />
              <span className="font-bold">o amanhã</span>
            </h1>
            ...
            <div className="text-lg flex md:justify-end  gap-3 pt-9">
              ...
              <Link to="/login">
                <button className="text-lg font-bold bg-white border w-[100px]  md:w-[150px] rounded-2xl py-2 hover:bg-buttonColor hover:border-white hover:text-white transform hover:scale-90 transition duration-300  ">
                  Login
                </button>
              </Link>
            </div>
